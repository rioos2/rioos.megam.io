...
Archived documentation for **Rio/OS** — a private cloud operating system originally shipped by Rio Advancement Inc and later stewarded by [Megam Systems LLP](https://megam.io) in Chennai. Active development ended October 2018.
...
Netlify auto-detects Next.js and runs `@netlify/plugin-nextjs`. The DNS for `docs.rioos.megam.io` is already pointed at Netlify; merging to `master` deploys.
