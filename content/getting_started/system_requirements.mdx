...
![Datacenter architecture view](/img/system_requirements/rioos_architecture_overview.png)
...
![Rio OS Minimum System requirements](/img/system_requirements/rioos_topology_minimal.png)
...
![Topology recommended](/img/system_requirements/rioos_topology_local.png)
...
- [Storage Plugins](/storages).
- [Failover of Rio/OS software](/high_availability).
- [Failover of Nodes in a region](/high_availability/failover#in_region).
- [Failover across regions](/high_availability/failover#across_region).

![Rio OS HA system requirements are](/img/system_requirements/rioos_topology_ceph.png)
...
![Topology receommended](/img/system_requirements/rioos_topology_local.png)
...
![Topology Ceph for HA](/img/system_requirements/rioos_topology_ceph.png)

In this, any number of disks can be pooled to create a ceph cluster.

#### Storage Plugin: My storage isn't listed here.

Great, contact ~~support@rio.company~~ → [nkishore@megam.io](mailto:nkishore@megam.io), If you need plugin for other storages (eg: Nexanta, iSCSI, NetApp..).
