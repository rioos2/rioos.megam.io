...
> **Request access** — Contact sales@rio.company for requesting access to the private link.
...
> **Request access** — Contact sales@rio.company for requesting access to the private registry CA certificate.
...
Read more about [Locations](/datacenters) to configure and use the datacenter.
