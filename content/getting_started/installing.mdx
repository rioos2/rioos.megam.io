...
![Rio/OS Components](/img/RIO_OS_Master_Software.png)
...
![Rio/OS Hub and Spoke](/img/RIO_OS_Hub_Spoke.png)
...
> **Request access** — Contact ~~sales@rio.company~~ → [nkishore@megam.io](mailto:nkishore@megam.io) for requesting access to the private link.

Download the ISO from [the private link here](https://drive.google.com/drive/u/1/folders/1Be88vR2NjywQfE_cDN4-ge0x9U8V2SWa). Burn the ISO into the USB using your platform specific instructions.
...
> **Pre requisites** — Ruby 2.5.x installed in your workstation.

### Install 

Visit [Autorio](https://github.com/rioos2/autorio) for detailed instruction.
...
> **Caution** — exported variables are persistent in your current bash terminal only. If you open another terminal then perform the export again in the new terminal.
...
> **Request access** — Contact ~~sales@rio.company~~ → [nkishore@megam.io](mailto:nkishore@megam.io) for requesting access to the private registry CA certificate.

Contact ~~sales@rio.company~~ → [nkishore@megam.io](mailto:nkishore@megam.io) requesting access to the below link.
...
> **Version** — 2.0.0-rc3 is the latest version referenced as `$RIOOS_VERSION`. Verify the release notes for newer versions.
...
> - Make sure `jq` package for your operating system is installed.
...
See [Nodes guide](/nodes) to configure and use the nodes
...
Read more about [Storage](/storages) to configure and use the storage.
...
Read more about [Locations](/datacenters/index) to configure and use the datacenter.
