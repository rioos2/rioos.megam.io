...
To make sure the [Rio/OS components](/getting_started/) run rock solid the typical active-active, load balanced architecture as shown below is used. 
...
We’ll take a closer look at the various option of the deployment in [Plan Rio/OS](/getting_started/system_requirements)
