...
![Rio/OS Virtual Network](/img/Rio_OS_Virtual_Network.png)
...
Refer [Asciicast in cli](/cli). 

**UI**

Click > **Networks** > **Create**

![A cluster of nodes with private and public networking/local storage grouped in Location NEWYORK 01](/img/infra/create_network.png)

Click > **Create**

The newly created virtual network is listed as below.

![A cluster of nodes with private and public networking/local storage grouped in Location NEWYORK 01](/img/infra/create_network_done.png)

Rio OS automatically manages used and unsed ips of a virtual network from the range provided for a node.

The newly created virtual network is ready for selection during creation of  [Datacenters](/datacenters/index)
